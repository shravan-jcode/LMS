...
export const generateCertificate = async (user, course, res, creatorName) => {
  try {
    ...
    // --- Set Safe Filename ---
    const safeTitle = course.courseTitle.replace(/[^a-z0-9]/gi, "_");
    ...
    // --- Colors ---
    const darkTeal = "#004D40";
    const lightTeal = "#4DB6AC";
    const mutedGold = "#C1A36E";
    const black = "#000000";
    const grey = "#616161";
    ...
    doc.font("Helvetica")
      .fontSize(10)
      .fillColor(grey)
      .text("Completion Date", leftX, footerY + 25, { width: columnWidth, align: "center" });
    ...
    doc.font("Times-BoldItalic")
      .fontSize(18)
      .fillColor(darkTeal)
      .text(creatorName, rightX, footerY - 5, { width: columnWidth, align: "center" });
    ...
    doc.font("Helvetica")
      .fontSize(10)
      .fillColor(grey)
      .text("Authorized Signature", rightX, footerY + 25, { width: columnWidth, align: "center" });
    ...
    doc.font("Helvetica")
      .fontSize(8)
      .fillColor(grey)
      .text(`Verification ID: ${certificateId}`, 50, bottomY, { width: 200, align: "left" });
