...
const InstructoLogin = () => {
  const [signupInput, setSignupInput] = useState({
    name: "",
    email: "",
    password: "",
    role: "instructor", // fixed role
  });
  ...
  // Preselect tab if navigated with state
  useEffect(() => {
            ...
            <Card className="mt-6 shadow-xl border border-gray-200 dark:border-gray-800 dark:bg-gray-950/80 backdrop-blur-md">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-500 dark:text-gray-400">
                  Fill in the details below to create your instructor account.
                </CardDescription>
              </CardHeader>
